<%@ Page Title="Asset Manager" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AssetManager.aspx.vb" Inherits="RWACApplication.AssetManager" EnableEventValidation="false" MaintainScrollPositionOnPostBack = "true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    List : <asp:DropDownList ID="ddlType" runat="server" Width ="200px" AutoPostBack ="True" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlType_OnSelectedIndexChanged">
              <asp:ListItem Text="Transaction" Value="Transaction" Selected="true"/>
              <asp:ListItem Text="Collateral" Value="Collateral" />
              </asp:DropDownList>  
    <br/><br/>
    <div class="table-responsive">  
