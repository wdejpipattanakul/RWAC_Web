...
Public Class CalculateRW
    ...
    Protected Sub Archive_Click(sender As Object, e As EventArgs) Handles Archive.Click
        ...
        strSQL = "SELECT DISTINCT aod from tbl_RWAC_Master where aod is not null"
        ...
        Else
            ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script language='javascript'>alert('Can't Calculae RWA.')</script>")
    ...
    Protected Sub CalculateRWA_Click(sender As Object, e As EventArgs) Handles CalculateRWA.Click
        ...
        ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script language='javascript'>alert('Calculate RWA Successfully')</script>")
        'MsgBox("Calculate RWA Successfully")
